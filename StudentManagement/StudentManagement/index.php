<?php
use Hermosura\StudentManagement\Core\Model\StudentModel;
...
<body>
    ...
    <div class="form-container">
        <form method="post">
            ...
            <input type="text" name="yearlevel"><br>
...
<td><?php echo isset($studentRow['year_level']) ? htmlspecialchars($studentRow['year_level']) : ''; ?></td>
<td><?php echo isset($studentRow['section']) ? htmlspecialchars($studentRow['section']) : ''; ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align: center; color: #999;">No students found</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
